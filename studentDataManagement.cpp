...
int main()
{
    char data[15]; // considering the max length of name to be 15
    ...
    // The following for loop counts the total # lines in the file
    for (int i = 0; std::getline(f, line); i++)
        count_n++;

    while (option != 6)
    {
        // Prints out all the available operations in the db
        ...
        else if (option == 2)
        {
            ...
            while (infile >> data)
            {
                if (strcmp(data, regno) == 0)
                {
                    ...
                    infile >> data;
                    cout << "PE1001 mark: " << data
                         << endl;

                    infile >> data;
                    cout << "PE1002 mark: " << data
                         << endl;
        ...
        else if (option == 3)
        {
            ...
            cin >> subcode;
            string code1 = "PE01001", code2 = "PE01002",
                   mark = "";
            ifstream infile;
            int check = 0;
        ...
        else if (option == 4)
        {
            ...
            while (infile >> temp1)
            {
                ...
                if (strcmp(id, procid) == 0)
                {
                    ...
                    cout << "PE1001 Mark: " << temp3
                         << endl;
                    cout << "PE1002 Mark: " << temp4
                         << endl;
                    check = 1;
                }
            }
